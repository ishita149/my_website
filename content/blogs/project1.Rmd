...
```{r movies_by_genre, echo=TRUE, warning=FALSE}
...
```{r rob_movies, echo=TRUE, warning=FALSE}
...
```{r avg_gross_and_budget_table, echo=TRUE, warning=FALSE}
...
```{r top_15_directors_table, echo=TRUE, warning=FALSE}
...
```{r genre_distribution, echo=TRUE, warning=FALSE}
...
```{r gross_fblikes, echo=TRUE, warning=FALSE}
...
```{r, gross_on_budget, echo=TRUE, warning=FALSE}
...
```{r gross_on_rating, echo=TRUE, warning=FALSE}
